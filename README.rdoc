...
EFAR Alert is a web-application that includes everything needed for small governments to manage emergency layperson first responders.
...
At the moment EFAR alert is used by the provincial EMS for the Western Cape in South Africa. 

= Who made the software? Who should I contact if I wish to use it?

The program was developed by David Crockett. Feel free to send any correspondance to my GitHub account.